...
use NathanLeading\Slack\Message;
use NathanLeading\Slack\Attachment;

class MessageUnitTest extends PHPUnit_Framework_TestCase
{
    public function testInstantiation()
    {
        $this->assertInstanceOf('NathanLeading\Slack\Message', $this->getMessage());
    }
    ...
    {
        return new Message(Mockery::mock('NathanLeading\Slack\Client'));
    }
}
