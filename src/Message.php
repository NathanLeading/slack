...
class Message
{
     ...
     * the message.
     *
     * @var \NathanLeading\Slack\Client
     */
    protected $client;
     ...
     *
     * @param \NathanLeading\Slack\Client $client
     * @return void
     */
    ...
    public function attach($attachment)
    {
        ...
        throw new InvalidArgumentException('Attachment must be an instance of NathanLeading\\Slack\\Attachment or a keyed array');
    }
